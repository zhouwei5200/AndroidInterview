...
import com.guowei.android.presenter.fragmentpresenter.JavaPresenter;
 ...
 */
@RequiresPresenter(JavaPresenter.class)
public class JavaFragment extends BaseAppFragment<JavaPresenter> {

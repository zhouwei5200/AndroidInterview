...
import com.guowei.android.presenter.fragmentpresenter.ArithmeticPresenter;
 ...
 */
@RequiresPresenter(ArithmeticPresenter.class)
public class ArithmeticFragment extends BaseAppFragment<ArithmeticPresenter> {
